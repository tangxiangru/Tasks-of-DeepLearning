...
cfg = {
    'VG': [64, 64, 'M', 128, 128, 'M', 256, 256, 256, 256, 'M', 512, 512, 512, 512, 'M', 512, 512, 512, 512, 'M'],
}

def vgg19(pretrained=False, model_root=None, **kwargs):
    model = VGG(make_layers(cfg['VG']), **kwargs)
    if pretrained:
...
def vgg19_bn(**kwargs):
    ...
    return VGG(make_layers(cfg['VG'], batch_norm=True), **kwargs)
